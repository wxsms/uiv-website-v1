...
<p>
<a href="https://www.jetbrains.com/?from=uiv"><img width="250" :src="$withBase('/assets/image/funding/jetbrains-logo.png')" alt="jetbrains-logo.png"></a>
</p>
...
<p>
<img width="250" :src="$withBase('/assets/image/funding/alipay.png')" alt="alipay.png">
<img width="250" :src="$withBase('/assets/image/funding/wxpay.png')" alt="wxpay.png">
</p>
